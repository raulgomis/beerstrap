        ...
        <div class="col-md-9">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <g:countrySelect name="country" value="${userInstance?.preferences?.country}" noSelection="['': '-Choose your country-']"
                                     class="form-control"/>
                </div>

                <div class="form-group">
                    <label class="control-label"><g:message code="user.preferences.locale.label" default="Locale"/></label>
                    <g:localeSelect name="locale" value="${userInstance?.preferences?.locale}" noSelection="['': '-Choose your locale-']"
                                    class="form-control"/>
                </div>
